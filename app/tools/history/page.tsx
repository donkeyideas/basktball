...
interface Season {
  ...
  championAbbreviation: string;
  mvp: string;
  mvpHeadshot: string | null;
  mvpEspnId: string | null;
  finalsScore: string;
  topScorer: string;
  topScorerHeadshot: string | null;
  topScorerEspnId: string | null;
  topScorerPpg: number;
}
            ...
            <div className="section">
              ...
              <div style={{ display: "grid", gap: "0" }}>
                ...
                {seasons.map((season, index) => {
                  ...
                  const champLogoUrl = season.championLogo;
                  const champPageUrl = getTeamPageUrl(season.champion);
                  const mvpHeadshotUrl = season.mvpHeadshot;
                  const mvpPageUrl = getPlayerPageUrl(season.mvp);
                  const scorerHeadshotUrl = season.topScorerHeadshot;
