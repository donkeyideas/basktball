...
export default function PredictorPage() {
  ...
  const getTeamLogo = (team: Team) => {
    return team.logoUrl || `https://a.espncdn.com/i/teamlogos/nba/500/${team.abbreviation.toLowerCase()}.png`;
  };
            ...
            <>
              ...
              <div className="section">
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "20px", marginBottom: "10px" }}>
                  <div style={{ flex: "0 0 auto", textAlign: "center", minWidth: "100px" }}>
                    {homeTeam && (
                      <img
                        src={getTeamLogo(homeTeam)}
                        alt={homeTeam.name}
              ...
              <p style={{
                ...
                Predictions are generated from statistical models and team performance data. For entertainment purposes only.
              </p>
            </>
          )}
        </div>
